...
struct ScienceSourcesView: View {
    ...
    private let groups: [Group] = [
        Group(heading: "TRAINING PACES & PLAN", sources: [
            ...
            Source(title: "Recent-to-usual load context (acute:chronic ratio)",
                   citation: "Impellizzeri FM, et al. Acute:Chronic Workload Ratio: Conceptual Issues and Fundamental Pitfalls. Int J Sports Physiol Perform. 2020;15(6):907–913.",
