    ...
    static func featured(now: Date = Date()) -> [CommunityAthlete] {
        ...
        return [
            ...
            CommunityAthlete(handle: theo.handle, name: theo.name, location: theo.location,
                ...
                posts: [post(2, theo, .strength, ago(4), "Lower power", "Squats moving well at 3 plates.", "12,400 lb · 18 sets · 1:02", lat: 40.71, lon: -74.01, pr: "Squat e1RM PR", reactions: 67)]),
            CommunityAthlete(handle: lin.handle, name: lin.name, location: lin.location,
                ...
                posts: [post(3, lin, .ride, ago(7), "Hill repeats", nil, "24.3 mi · 1:31", lat: 45.52, lon: -122.68, reactions: 18)]),
            ...
            CommunityAthlete(handle: marcus.handle, name: marcus.name, location: marcus.location,
                ...
                posts: [post(5, marcus, .swimming, ago(20), "Pool intervals", "2km steady.", "38:42", lat: 25.76, lon: -80.19, reactions: 14)]),
            ...
            CommunityAthlete(handle: amara.handle, name: amara.name, location: amara.location,
                ...
                posts: [post(8, amara, .walk, ago(46), "Recovery walk", "Easy day, clear head.", "3.1 mi · 47:20", lat: 47.61, lon: -122.33, reactions: 23)]),
        ]
    }
