    ...
    static func all(now: Date = Date()) -> [CommunityAthlete] {
        ...
        return [
            CommunityAthlete(handle: maya.handle, name: maya.name, location: maya.location,
                ...
                posts: [post(1, maya, .run, ago(1.5), "Sunrise tempo", "Negative split the whole way. Felt strong.", "6.2 mi · 48:10", pr: "5K PR", route: Routes.loop, reactions: 42)]),
            CommunityAthlete(handle: theo.handle, name: theo.name, location: theo.location,
                ...
                posts: [post(2, theo, .strength, ago(4), "Lower power", "Squats moving well at 3 plates.", "12,400 lb · 18 sets · 1:02", pr: "Squat e1RM PR", reactions: 67)]),
            CommunityAthlete(handle: lin.handle, name: lin.name, location: lin.location,
                ...
                posts: [post(3, lin, .ride, ago(7), "Hill repeats", nil, "24.3 mi · 1:31", route: Routes.wander, reactions: 18)]),
            CommunityAthlete(handle: priya.handle, name: priya.name, location: priya.location,
                ...
                posts: [post(4, priya, .hiit, ago(11), "Conditioning", "Quick and brutal.", "22:00", reactions: 9)]),
            ...
            CommunityAthlete(handle: sofia.handle, name: sofia.name, location: sofia.location,
                ...
                posts: [post(6, sofia, .trailRun, ago(28), "Mesa loop", "Big climb, bigger views.", "8.0 mi · 1:14", pr: "Longest run", route: Routes.bigLoop, reactions: 51)]),
            CommunityAthlete(handle: devon.handle, name: devon.name, location: devon.location,
                ...
                posts: [post(7, devon, .rowing, ago(33), "Steady state", nil, "40:00", reactions: 7)]),
            CommunityAthlete(handle: amara.handle, name: amara.name, location: amara.location,
                ...
                posts: [post(8, amara, .walk, ago(46), "Recovery walk", "Easy day, clear head.", "3.1 mi · 47:20", reactions: 23)]),
        ]
    }
