...
extension Font {
    ...
    /// taglines (e.g. "keep moving" under the wordmark). → system serif (New York); no bundled
    /// serif ships, and New York is the closest system match to the rounded-serif logo.
