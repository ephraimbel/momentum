...
enum RaceCatalog {
    ...
    static let races: [Race] = [
        ...
        Race(id: "boston", name: "Boston Marathon", city: "Boston", country: "USA", flag: "🇺🇸",
             region: .majors, distance: .marathon, rule: .init(month: 4, weekday: mon, ordinal: 3)),
        Race(id: "london", name: "London Marathon", city: "London", country: "UK", flag: "🇬🇧",
             region: .majors, distance: .marathon, rule: .init(month: 4, weekday: sun, ordinal: -1)),
        Race(id: "berlin", name: "Berlin Marathon", city: "Berlin", country: "Germany", flag: "🇩🇪",
             region: .majors, distance: .marathon, rule: .init(month: 9, weekday: sun, ordinal: -1)),
        Race(id: "chicago", name: "Chicago Marathon", city: "Chicago", country: "USA", flag: "🇺🇸",
             region: .majors, distance: .marathon, rule: .init(month: 10, weekday: sun, ordinal: 2)),
        Race(id: "nyc", name: "New York City Marathon", city: "New York", country: "USA", flag: "🇺🇸",
             region: .majors, distance: .marathon, rule: .init(month: 11, weekday: sun, ordinal: 1)),
        Race(id: "tokyo", name: "Tokyo Marathon", city: "Tokyo", country: "Japan", flag: "🇯🇵",
             region: .majors, distance: .marathon, rule: .init(month: 3, weekday: sun, ordinal: 1)),
        Race(id: "sydney", name: "Sydney Marathon", city: "Sydney", country: "Australia", flag: "🇦🇺",
             region: .majors, distance: .marathon, rule: .init(month: 8, weekday: sun, ordinal: -1)),

        // United States — the big ones beyond the majors.
        Race(id: "la", name: "Los Angeles Marathon", city: "Los Angeles", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 3, weekday: sun, ordinal: 3)),
        Race(id: "houston", name: "Houston Marathon", city: "Houston", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 1, weekday: sun, ordinal: 3)),
        Race(id: "austin", name: "Austin Marathon", city: "Austin", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 2, weekday: sun, ordinal: 3)),
        Race(id: "marine-corps", name: "Marine Corps Marathon", city: "Washington, D.C.", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 10, weekday: sun, ordinal: -1)),
        Race(id: "philadelphia", name: "Philadelphia Marathon", city: "Philadelphia", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 11, weekday: sun, ordinal: 3)),
        ...
        Race(id: "grandmas", name: "Grandma's Marathon", city: "Duluth", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 6, weekday: sat, ordinal: 3)),
        Race(id: "cim", name: "California International Marathon", city: "Sacramento", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 12, weekday: sun, ordinal: 1)),
        Race(id: "big-sur", name: "Big Sur Marathon", city: "Big Sur", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 4, weekday: sun, ordinal: -1)),
        Race(id: "honolulu", name: "Honolulu Marathon", city: "Honolulu", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 12, weekday: sun, ordinal: 2)),
        Race(id: "sf", name: "San Francisco Marathon", city: "San Francisco", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 7, weekday: sun, ordinal: -1)),
        Race(id: "disney", name: "Walt Disney World Marathon", city: "Orlando", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 1, weekday: sun, ordinal: 2)),
        Race(id: "st-george", name: "St. George Marathon", city: "St. George", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 10, weekday: sat, ordinal: 1)),
        Race(id: "richmond", name: "Richmond Marathon", city: "Richmond", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 11, weekday: sat, ordinal: 2)),
        Race(id: "monumental", name: "Indianapolis Monumental Marathon", city: "Indianapolis", country: "USA", flag: "🇺🇸",
             region: .unitedStates, distance: .marathon, rule: .init(month: 11, weekday: sat, ordinal: 1)),

        // International icons.
        Race(id: "paris", name: "Paris Marathon", city: "Paris", country: "France", flag: "🇫🇷",
             region: .international, distance: .marathon, rule: .init(month: 4, weekday: sun, ordinal: 2)),
        ...
        Race(id: "amsterdam", name: "Amsterdam Marathon", city: "Amsterdam", country: "Netherlands", flag: "🇳🇱",
             region: .international, distance: .marathon, rule: .init(month: 10, weekday: sun, ordinal: 3)),
        Race(id: "valencia", name: "Valencia Marathon", city: "Valencia", country: "Spain", flag: "🇪🇸",
             region: .international, distance: .marathon, rule: .init(month: 12, weekday: sun, ordinal: 1)),
        Race(id: "barcelona", name: "Barcelona Marathon", city: "Barcelona", country: "Spain", flag: "🇪🇸",
             region: .international, distance: .marathon, rule: .init(month: 3, weekday: sun, ordinal: 3)),
        ...
        Race(id: "hong-kong", name: "Hong Kong Marathon", city: "Hong Kong", country: "Hong Kong", flag: "🇭🇰",
             region: .international, distance: .marathon, rule: .init(month: 2, weekday: sun, ordinal: 2)),
        Race(id: "great-wall", name: "Great Wall Marathon", city: "Tianjin", country: "China", flag: "🇨🇳",
             region: .international, distance: .marathon, rule: .init(month: 5, weekday: sat, ordinal: 3)),
        Race(id: "dublin", name: "Dublin Marathon", city: "Dublin", country: "Ireland", flag: "🇮🇪",
             region: .international, distance: .marathon, rule: .init(month: 10, weekday: sun, ordinal: -1)),
        ...
        Race(id: "vancouver", name: "Vancouver Marathon", city: "Vancouver", country: "Canada", flag: "🇨🇦",
             region: .international, distance: .marathon, rule: .init(month: 5, weekday: sun, ordinal: 1)),
        Race(id: "mexico-city", name: "Mexico City Marathon", city: "Mexico City", country: "Mexico", flag: "🇲🇽",
             region: .international, distance: .marathon, rule: .init(month: 8, weekday: sun, ordinal: -1)),
        Race(id: "athens", name: "Athens Authentic Marathon", city: "Athens", country: "Greece", flag: "🇬🇷",
             region: .international, distance: .marathon, rule: .init(month: 11, weekday: sun, ordinal: 2)),
