...
- **Tab layout (as of 2026-07): Today · Plan · Progress · Profile.** Today is map-centric — edge-to-edge map, floating glass header, deck of three thoughts (plan → Start → one utility line). **There is no History tab** — history is a segment inside Progress (Trends · History · You), with the personal heatmap as a look-back card at its top (a card, never a tab — decided 2026-06). Profile is a TikTok-style grid of workout tiles. Plan is a date-badge planner with macrocycle phase chips.
