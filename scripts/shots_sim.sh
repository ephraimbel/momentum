...
xcrun simctl launch $UD com.ephraimbel.momentum.app --seed-demo --seed-dense-history --seed-plan-long --seed-route-history --seed-fuel-history --seed-fuel-today --health-recovery-demo --awards-quiet "$@"
